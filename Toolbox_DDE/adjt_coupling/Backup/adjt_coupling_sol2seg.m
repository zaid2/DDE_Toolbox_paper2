function prob = adjt_coupling_sol2seg(prob, oid, varargin)
...
% [fdata,axidx] = coco_get_adjt_data(prob,tbid,'data','axidx');

% sol  = coupling_read_adjoint(args.soid, gidx, args.run, args.lab, args.point);
[sol,~] = coupling_read_adjoint(oid, args.run, args.lab, args.point);
