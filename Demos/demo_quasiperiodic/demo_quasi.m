...
coco(prob,'run1',[],1,{'alpha','om1','Texc'},{[0.1,0.75],[]})
...
coco(prob,'run2',[],1,{'om1','Texc','alpha'},{[],[3.5,4.2]})
...
prob = coco_set(prob,'cont','ItMX',[0,500]);
coco(prob,'run3',[],1,{'om1','Texc','d.om1','d.alpha'},{[],[3.5,3.75]})
...
coco(prob,'run4',[],1,{'d.om1','om1','Texc','d.alpha'},{[0, 1]})
...
coco(prob,'run5',[],1,{'d.alpha','om1','Texc','alpha'},{[],[],[pi,4*pi],[0.1,2.5]})
